...
$Recorder = Join-Path $LabRoot "scratch\record_h3_music_attempt4_operator_launch.py"
$AttemptId = "h3music-20260810T023023Z-97ca44b2-attempt-004"
...
if ($CampaignExitCode -ne 0) {
    throw "Attempt-004 exited $CampaignExitCode; immutable transport evidence was retained"
}
