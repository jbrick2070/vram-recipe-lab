...
rem Custom nodes fail closed to the two locally required packs. In particular,
rem ComfyUI-Manager is not loaded, so the offline lab cannot refresh registries.
set PYTHONUTF8=1
...
C:\Users\jeffr\Documents\ComfyUI\.venv\Scripts\python.exe ^
  ...
  --whitelist-custom-nodes ComfyUI-GGUF ComfyUI-KJNodes %EXTRA_ARGS% ^
  >> "%~dp0server.log" 2>&1
