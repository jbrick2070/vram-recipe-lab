...
| `wan_ti2v_low` | smoke | PASS | 13.15 | N/A | no | 14.6s | lab-8199, sage-free | 2026-08-07 | Wan 2.2 5B Q5_K_M GGUF (PASS) |
| `wan_ti2v_high` | smoke | FAIL | 15.55 | N/A | no | 46.3s | lab-8199, sage-free | 2026-08-07 | Peak 15.55 GB > 14.5 GB gate line |
| `wan_i2v_14b_low` | smoke | FAIL | 15.28 | N/A | no | 19.7s | lab-8199, sage-free | 2026-08-07 | Wan 2.2 14B FP8; Peak 15.28 GB > 14.5 GB gate line |
| `wan_i2v_14b_high` | smoke | FAIL | 15.34 | N/A | no | 30.0s | lab-8199, sage-free | 2026-08-07 | Wan 2.2 14B FP8; Peak 15.34 GB > 14.5 GB gate line |
| `ltx_i2v_low` | smoke | ERROR | 10.84 | N/A | no | 7.5s | lab-8199, sage-free | 2026-08-07 | Wiring/graph fault: LTXAV embedding shape mismatch |
| `ltx_i2v_high` | smoke | ERROR | 10.51 | N/A | no | 6.1s | lab-8199, sage-free | 2026-08-07 | Wiring/graph fault: LTXAV embedding shape mismatch |
| `ltx_audio_low` | smoke | ERROR | 10.82 | N/A | no | 4.5s | lab-8199, sage-free | 2026-08-07 | Wiring/graph fault: LTXAV audio connector shape mismatch |
...
Columns: `tier` = smoke / suite. `status` = PASS / FAIL / ERROR / BLOCKED / beta.
