...
| h3_r2v_refaudio_static_control | experiment | UNRENDERED/HELD | 0.00 | 0.0 | no | 0/2 | lab-8199, sage-free | never | TTS is the only RefAudio cell rendered so far |
| h3_r2v_refaudio_music_opening | experiment | UNRENDERED/HELD | 0.00 | 0.0 | no | 0/2 | lab-8199, sage-free | never | TTS is the only RefAudio cell rendered so far |
| h3_mime_i2v | experiment | GATE PASS (cold-only); HUMAN APPROVED CONTINUATION; FORMAL EAR FIELDS PENDING | 7.28 | 178.9 | yes | 1/2 | lab-8199, sage-free, no-pinned, reserve-12gb | 2026-08-08 | Exact 90 frames/3.750 s; native audio -27.5 LUFS; Jeffrey authorized one R2V proof, but the one-line soundscape receipt field remains pending |
| h3_mime_r2v | experiment | GATE PASS (cold-only); HUMAN EYE/EAR PENDING | 7.23 | 188.3 | yes | 1/2 | lab-8199, sage-free, no-pinned, reserve-12gb | 2026-08-08 | Exact 90 frames/3.750 s; strong objective portrait stability; native audio about -40.5 LUFS; final authorized mime render, no promotion |
